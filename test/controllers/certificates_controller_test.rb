...
class CertificatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certificate" do
    assert_difference("Certificate.count") do
      post certificates_url, params: { certificate: { name: @certificate.name, qr_code: @certificate.qr_code, user_id: @certificate.user_id } }
    end
  ...
  test "should update certificate" do
    patch certificate_url(@certificate), params: { certificate: { name: @certificate.name, qr_code: @certificate.qr_code, user_id: @certificate.user_id } }
