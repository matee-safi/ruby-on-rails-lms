...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference("Grade.count") do
      post grades_url, params: { grade: { academic_class_id: @grade.academic_class_id, user_id: @grade.user_id, value: @grade.value } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { academic_class_id: @grade.academic_class_id, user_id: @grade.user_id, value: @grade.value } }
